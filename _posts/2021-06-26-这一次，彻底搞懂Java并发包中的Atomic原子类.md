...
![E0515809-563E-49E5-95F0-2B58164BD732.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713173544843.webp)
...
![cas.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713173814594.webp)
...
Unsafe是一个神奇且鲜为人知的Java类，因为在平时开发中很少用到它。但是这个类中为我们提供了相当多的功能，它即可以让Java语言像C语言指针一样操作内存，同时还提供了CAS、内存屏障、线程调度、对象操作、数组操作等能力,如下图。 ![Unsafe](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713173949522.webp)
