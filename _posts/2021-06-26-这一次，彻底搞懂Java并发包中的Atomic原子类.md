...
开始之前先给大家推荐一下[AndroidNote](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fzhpanvip%2FAndroidNote)这个GitHub仓库，这里是我的学习笔记，同时也是我文章初稿的出处。这个仓库中汇总了大量的java进阶和Android进阶知识。是一个比较系统且全面的Android知识库。对于准备面试的同学也是一份不可多得的面试宝典，欢迎大家到GitHub的仓库主页关注。

## 一、初始Atomic并发包

从JDK1.5开始，Java在java.util.concurrent.atomic包下引入了一些Atomic相关的原子操作类，这些类避免使用加锁来实现同步，从而更加方便、高效的实现原子操作。atomic包下的所有类如下图所示：

![E0515809-563E-49E5-95F0-2B58164BD732.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713173544843.awebp)
...
![cas.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713173814594.awebp)
...
Unsafe是一个神奇且鲜为人知的Java类，因为在平时开发中很少用到它。但是这个类中为我们提供了相当多的功能，它即可以让Java语言像C语言指针一样操作内存，同时还提供了CAS、内存屏障、线程调度、对象操作、数组操作等能力,如下图。 ![Unsafe](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713173949522.awebp)
...
关于Gson使用allocateInstance实例化对象的详细过程可以可以参考[《一个非静态内部类引起的空指针》](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fzhpanvip%2FAndroidNote%2Fwiki%2F%E9%A1%B9%E7%9B%AE%E4%B8%AD%E9%81%87%E5%88%B0%E7%9A%84%E9%97%AE%E9%A2%98)
...
[Java魔法类：Unsafe应用解析](https://link.juejin.cn?target=https%3A%2F%2Ftech.meituan.com%2F2019%2F02%2F14%2Ftalk-about-java-magic-class-unsafe.html)

[Java并发编程-无锁CAS与Unsafe类及其并发包Atomic](https://link.juejin.cn?target=https%3A%2F%2Fblog.csdn.net%2Fjavazejian%2Farticle%2Fdetails%2F72772470)
