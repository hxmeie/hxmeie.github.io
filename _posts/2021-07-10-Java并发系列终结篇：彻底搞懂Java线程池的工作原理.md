...
date: 2021-07-10 10:00:00 +0800
pin: false
tags: [转载, Java]
keywords: [Java, 线程池, ThreadPoolExecutor, 并发, AQS]
---

> 本文转载自 [Java并发系列终结篇：彻底搞懂Java线程池的工作原理](https://juejin.cn/post/6983213662383112206)。版权归原作者所有，此处仅作个人学习备份。
...
[这一次，彻底搞懂Java内存模型与volatile关键字](https://juejin.cn/post/6967739352784830494 "https://juejin.cn/post/6967739352784830494")

[这一次，彻底搞懂Java中的synchronized关键字](https://juejin.cn/post/6973571891915128846 "https://juejin.cn/post/6973571891915128846")

[这一次，彻底搞懂Java中的ReentrantLock实现原理](https://juejin.cn/post/6975435256111300621 "https://juejin.cn/post/6975435256111300621")

[这一次，彻底搞懂Java并发包中的Atomic原子类](https://juejin.cn/post/6977993272538955806 "https://juejin.cn/post/6977993272538955806")

[深入理解Java线程的等待与唤醒机制（一）](https://juejin.cn/post/6980002998361522190 "https://juejin.cn/post/6980002998361522190")

[深入理解Java线程的等待与唤醒机制（二）](https://juejin.cn/post/6980655421497278495/ "https://juejin.cn/post/6980655421497278495/")

[Java并发系列终结篇：彻底搞懂Java线程池的工作原理](https://juejin.cn/post/6983213662383112206/ "https://juejin.cn/post/6983213662383112206/")

[Java并发系列番外篇：ThreadLocal原理其实很简单](https://juejin.cn/post/6986301941269659656 "https://juejin.cn/post/6986301941269659656")
...
![threadpoollifecycle.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103713538.awebp)
...
![thread_pool1.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103732527.awebp)

（2）当execute方法提交一个任务时，线程池中的线程数已经达到了corePoolSize,且此时没有空闲的线程，那么则会将任务存储到workQueue中。

![thread_pool2.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103742772.awebp)
（3）如果execute提交任务时线程池中的线程数已经到达了corePoolSize,并且workQueue已满，那么则会创建新的线程来执行任务，但总线程数应该小于maximumPoolSize。
![thread_pool3.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103756962.awebp)

（4）如果线程池中的线程执行完了当前的任务，则会尝试从workQueue中取出第一个任务来执行。如果workQueue为空则会阻塞线程。

![thread_pool4.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103823689.awebp)

（5）如果execute提交任务时，线程池中的线程数达到了maximumPoolSize，且workQueue已满，此时会执行拒绝策略来拒绝接受任务。

![thread_pool5.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103836235.awebp)

（6）如果线程池中的线程数超过了corePoolSize，那么空闲时间超过keepAliveTime的线程会被销毁，但程池中线程个数会保持为corePoolSize。

![thread_pool6.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103845780.awebp)

（7）如果线程池存在空闲的线程，并且设置了allowCoreThreadTimeOut为true。那么空闲时间超过keepAliveTime的线程都会被销毁。

![thread_pool7.png](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260707103857520.awebp)
...
其实说白了，阻塞队列就是一个使用ReentrantLock实现的"生产者-消费者"模式，我们在[深入理解Java线程的等待与唤醒机制（二）](https://juejin.cn/post/6980655421497278495/ "https://juejin.cn/post/6980655421497278495/")这篇文章中使用ReentrantLock实现"生产者-消费者"模型其实就是一个简单的阻塞队列，与JDK中的BlockingQueue实现机制类似。感兴趣的同学可以自己查看ArrayBlockingQueue等阻塞队列的实现，限于文章篇幅，这里就不再赘述了。
