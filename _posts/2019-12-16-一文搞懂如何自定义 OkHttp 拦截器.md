...
[官方文档](https://link.juejin.cn?target=https%3A%2F%2Fsquare.github.io%2Fokhttp%2Finterceptors%2F) 中介绍了如何自定义一个 Interceptor，代码如下：
...
OkHttp 默认实现的拦截器这里不再讲述，可以参考这篇文章 [okhttp3 拦截器源码分析](https://juejin.cn/post/6844903567468281869) 这里我们只关心拦截器的添加顺序。
...
- 打印请求日志，可以直接参考官方提供的 [HttpLoggingInterceptor](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fsquare%2Fokhttp%2Fblob%2Fmaster%2Fokhttp-logging-interceptor%2Fsrc%2Fmain%2Fjava%2Fokhttp3%2Flogging%2FHttpLoggingInterceptor.kt)
- Gzip 加密
- 抓包：参考 [steho](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Ffacebook%2Fstetho)
- DNS 相关
- 修改 url 进行重定向
...
此外，比较有趣的是 request 还有一个 tag 字段，如果你使用 retrofit 的话，它有一个实用的用法，有兴趣的可以看一下 [使用拦截器扩展 retrofit 的注解类型](https://juejin.cn/post/6844904020792836104)。
...
![img](https://cdn.jsdelivr.net/gh/hxmeie/tuchuang/images/20260713105552609.png)
...
Connection 包含了本次网络请求比较底层的 socket，握手操作等，目前只看到抓包工具 [Steho](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Ffacebook%2Fstetho) 在使用。

#### 参考

[okhttp3 拦截器源码分析](https://juejin.cn/post/6844903567468281869)
