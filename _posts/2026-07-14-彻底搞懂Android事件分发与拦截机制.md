...
mermaid: true
description: 用「公司派文件」的比喻把 dispatchTouchEvent / onInterceptTouchEvent / onTouchEvent 三个方法讲透，配 U 型流程图、源码精简版、滑动冲突两种解法，最后补上 Jetpack Compose 的 PointerEventPass 事件拦截原理与对照，文末附面试话术。
---
